#!/bin/bash
cd ~/NonBackup/SIILO
/usr/local/bin/nativefier --name "Siilo" https://web.siilo.com --single-instance --counter -p windows -a x64  --inject ./unread.js --icon ./icon.ico --app-user-model-id Nativefier.Siilo
/usr/local/bin/nativefier --name "Siilo" https://web.siilo.com --single-instance --counter  --inject ./unread.js --tray --icon ./icon.icns  
